...
export const buttonClass =
  'inline-flex h-11 shrink-0 items-center justify-center rounded-button bg-(--button-bg) px-5 text-ui font-medium text-(--button-fg) transition-colors duration-(--duration-hover) ease-standard hover:bg-(--button-bg-hover) active:scale-[0.98] disabled:opacity-40';
